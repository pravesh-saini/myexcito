    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-100 via-pink-50 to-purple-100 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900">
      ...
      <div className="relative py-14 px-4 lg:px-8">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://thumbs.dreamstime.com/b/female-sports-clothing-relaxing-workout-image-black-background-muscular-body-sweat-57562765.jpg')",
          }}
        ></div>
        <div className="absolute inset-0 bg-gradient-to-r from-pink-950/65 via-black/45 to-purple-950/65"></div>
