          ...
          >
            ...
            <div className="mt-2.5 sm:mt-3">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm sm:text-base font-bold text-gray-900 dark:text-gray-100">&#8377;{Number(product.price).toLocaleString()}</span>
                {product.original_price && <span className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 line-through">&#8377;{Number(product.original_price).toLocaleString()}</span>}
              </div>
            </div>
          </div>
        ))}
